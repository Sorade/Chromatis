...
public class PlayerShooting : MonoBehaviour
{
	...
	void Shoot ()
	{
		...
		gunLine.material.color = rayColor;
		...
		if(Physics.Raycast (shootRay, out shootHit, range, shootableMask))
		{
			...
			/*GameObject vfx = Instantiate (rayVFX, transform.position, Quaternion.identity);
			MoveAndDestroy moveAndDestroy = vfx.GetComponent<MoveAndDestroy> ();
			if (moveAndDestroy != null) {
				moveAndDestroy.destination = shootHit.point;
			}*/
		}
